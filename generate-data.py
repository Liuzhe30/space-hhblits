...
def generate_data(partition):
    ...
    with open(file_path) as file:
        ...
        while line:
            ...
            if(line[0] == '>'):
                ...
                seq_len = len(seq)
                feature_matrix = np.zeros([seq_len + 2 * t, 22+2555], float) # 20+(dis:2555/1/5/10/20)+1+1,onehot+distancemap+noseq+mask
                shhm_matrix = np.loadtxt(os.path.join(shhm_path, uniprot_id + ".npy"))
                # check padding
                for i in range(feature_matrix.shape[0]):
                    if(i < t):
                        ...
                        feature_matrix[i,20:20+2555] = shhm_matrix[i - t,:]
    ...
    # output_path_x = 'data/dataset_' + str(distance) + 'A_' + filter_strategy + '_slidingwindow_' + partition + '_x.npy'
    # output_path_y = 'data/dataset_' + str(distance) + 'A_' + filter_strategy + '_slidingwindow_' + partition + '_y.npy'
...
if __name__ == '__main__':
    ...
    # multiprocessing_list.append((0, 'simple_average', 'training'))
    # multiprocessing_list.append((1, 'simple_average', 'training'))
    # multiprocessing_list.append((3, 'simple_average', 'training'))
    # multiprocessing_list.append((5, 'simple_average', 'training'))
    # multiprocessing_list.append((7, 'simple_average', 'training'))
    # multiprocessing_list.append((9, 'simple_average', 'training'))
    # multiprocessing_list.append((11, 'simple_average', 'training'))
    ...
    # multiprocessing_list.append((0, 'simple_average', 'validation'))
    # multiprocessing_list.append((1, 'simple_average', 'validation'))
    # multiprocessing_list.append((3, 'simple_average', 'validation'))
    # multiprocessing_list.append((5, 'simple_average', 'validation'))
    # multiprocessing_list.append((7, 'simple_average', 'validation'))
    # multiprocessing_list.append((9, 'simple_average', 'validation'))
    # multiprocessing_list.append((11, 'simple_average', 'validation'))
    ...
    # multiprocessing_list.append((0, 'simple_average', 'test'))
    # multiprocessing_list.append((1, 'simple_average', 'test'))
    # multiprocessing_list.append((3, 'simple_average', 'test'))
    # multiprocessing_list.append((5, 'simple_average', 'test'))
    # multiprocessing_list.append((7, 'simple_average', 'test'))
    # multiprocessing_list.append((9, 'simple_average', 'test'))
    # multiprocessing_list.append((11, 'simple_average', 'test'))
