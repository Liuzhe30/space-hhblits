...
checkpoint = tf.keras.callbacks.ModelCheckpoint(config_vars["experiment_dir"] + '/weights-{epoch:02d}.h5', monitor='val_mcc', mode='max', #val_categorical_accuracy val_acc
