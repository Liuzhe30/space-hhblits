...
x = np.load('/home/panwh/space-hhblits/data/dataset_0A_simple_average_shhm_exp_slidingwindow_x.npy')
y = np.load('/home/panwh/space-hhblits/data/dataset_0A_simple_average_shhm_exp_slidingwindow_y.npy')

train_gen = utils.data_provider.DataGenerator(#x = x[0:700000,:,0:50],
                                              #y = y[0:700000],
                                              x = x[0:900000,:,0:50],
                                              y = y[0:900000],
                                              ...
                                              is_training=True,
                                              shuffle= True)
val_gen = utils.data_provider.DataGenerator(#x = x[700000:1007941,:,0:50],
                                            #y = y[700000:1007941],
                                            x = x[900000:1007941,:,0:50],
                                            y = y[900000:1007941],
                                            batch_size=config_vars['batch_size'],
                                            is_training = False,
                                            shuffle = True)
...
model_CNN_BiLSTM.compile(loss=loss, metrics = metrics, optimizer=optimizer)
...
label = np.stack([y[900000:1007941],np.logical_not(y[900000:1007941])],axis=1)
