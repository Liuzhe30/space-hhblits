...
train_gen = utils.data_provider.DataGenerator(x = x[0:900000,:,0:50],
                                              y = y[0:900000],
                                              batch_size=config_vars['batch_size'],
                                              is_training=True)
val_gen = utils.data_provider.DataGenerator(x = x[900000:1007941,:,0:50],
                                            y = y[900000:1007941],
                                            batch_size=config_vars['batch_size'],
                                            is_training=False)
